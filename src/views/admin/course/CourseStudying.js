...
import courseAction from "@redux/actions/course/studying";
...
const CourseStudying = ({ role }) => {
  ...
  const loadPage = () => {
    let params = {
      ...state.param,
      status: constants.courseStatus.studying.value,
    };
...
export default connect(
  (state) => {
    return {
      ...
      listCourse: state.courseStudying.listCourseStudying,
      totalPage: state.courseStudying.totalPage,
    };
  },
  {
